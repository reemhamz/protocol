    ...
    */
    Modal.createModal = function(origin, content, opts) {
        ...
        var modalFragment =
            ...
            '      <div class="mzp-c-modal-previous">' +
            '        <button type="button" class="mzp-c-modal-button-previous">' + prevText + '</button>' +
            '      </div>' +
            '      <div class="mzp-c-modal-next">' +
            '        <button type="button" class="mzp-c-modal-button-next">' + nextText + '</button>' +
            '      </div>' +
